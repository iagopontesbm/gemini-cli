...
You can view your token usage and cached token savings using the `/stats` command. OAuth users will see cumulative token counts but not cached token information.

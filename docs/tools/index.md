...
Many tools, especially those that can modify your file system or execute commands (`edit`, `execute_bash_command`), are designed with safety in mind. The Gemini CLI will typically:

...
- **`@<path_to_file_or_directory>`**
  ...
  - **Details:**
    ...
    - **Git-aware filtering:** By default, git-ignored files (like `node_modules/`, `dist/`, `.env`, `.git/`) are excluded. Additionally, files can be ignored by creating a `.geminiignore` file. This behavior can be changed via the `fileFiltering` settings.

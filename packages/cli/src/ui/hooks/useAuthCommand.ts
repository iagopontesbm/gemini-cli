      ...
      try {
        ...
        const errorMessage =
          ...
          AuthType.LOGIN_WITH_GOOGLE_PERSONAL
            ? `Failed to login. Ensure your Google account is not a Workspace account and that you are not a licensed Code Assist user (see https://goo.gle/gemini-cli-auth-docs).

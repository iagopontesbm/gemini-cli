  ...
  describe('EditTool.getDescription parameter validation', () => {
    ...
    it('should return error message if file_path is empty, old_string and new_string are present', () => {
      ...
      expect(description).toBe(
        'EditTool params cannot be empty {file_path: , old_string: old content, new_string: new content}',
      );
    });
    ...
    it('should return error message if old_string is empty, file_path and new_string are present', () => {
      ...
      const description = tool.getDescription(params);
      expect(description).toBe(
        `EditTool params cannot be empty {file_path: ${testFilePath}, old_string: , new_string: new content}`,
      );
    });
    ...
    it('should return error message if new_string is empty, file_path and old_string are present', () => {
      ...
      const description = tool.getDescription(params);
      expect(description).toBe(
        `EditTool params cannot be empty {file_path: ${testFilePath}, old_string: old content, new_string: }`,
      );
    });
    ...
    it('should return error message if all relevant params (file_path, old_string, new_string) are empty', () => {
      ...
      const description = tool.getDescription(params);
      expect(description).toBe(
        'EditTool params cannot be empty {file_path: , old_string: , new_string: }',
      );
    });
    ...
    it('should return error message if file_path is undefined', () => {
      ...
      const description = tool.getDescription(params);
      expect(description).toBe(
        'EditTool params cannot be empty {file_path: undefined, old_string: old content, new_string: new content}',
      );
    });
    ...
    it('should return error message if old_string is undefined', () => {
      ...
      const description = tool.getDescription(params);
      expect(description).toBe(
        `EditTool params cannot be empty {file_path: ${testFilePath}, old_string: undefined, new_string: new content}`,
      );
    });
    ...
    it('should return error message if new_string is undefined', () => {
      ...
      const description = tool.getDescription(params);
      expect(description).toBe(
        `EditTool params cannot be empty {file_path: ${testFilePath}, old_string: old content, new_string: undefined}`,
      );
    });
    ...
    it('should return error message for "Create file" scenario due to new validation on empty old_string', () => {
      ...
      const description = tool.getDescription(params);
      expect(description).toBe(
        `EditTool params cannot be empty {file_path: ${newFilePath}, old_string: , new_string: content for new file}`,
      );
    });
    ...
    it('should produce a valid description for normal parameters with multi-line snippets', () => {
      ...
      expect(description).toBe(
        `${expectedShortenedPath}: ${expectedOldSnippet} => ${expectedNewSnippet}`,
      );
    });
    ...
    it('should produce a valid description with character truncation in snippets', () => {
      ...
      const oldContent =
        'This is a very long single line of text that will definitely exceed the eighty character limit for snippets and should be truncated with an ellipsis.';

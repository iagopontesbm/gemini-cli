...
describe('ReadFileTool', () => {
  ...
  describe('validateToolParams', () => {
    it('should return null for valid params (absolute path within root)', () => {
      const params: ReadFileToolParams = {
        abs_path: path.join(tempRootDir, 'test.txt'),
      };
    ...
    it('should return error for relative path', () => {
      const params: ReadFileToolParams = { abs_path: 'test.txt' };
    ...
    it('should return error for path outside root', () => {
      ...
      const params: ReadFileToolParams = { abs_path: outsidePath };
      expect(tool.validateToolParams(params)).toMatch(
  ...
  describe('getDescription', () => {
    it('should return a shortened, relative path', () => {
      ...
      const params: ReadFileToolParams = { abs_path: filePath };
    ...
    it('should return . if path is the root directory', () => {
      const params: ReadFileToolParams = { abs_path: tempRootDir };
  ...
  describe('execute', () => {
    it('should return validation error if params are invalid', async () => {
      const params: ReadFileToolParams = { abs_path: 'relative/path.txt' };
    ...
    it('should return error if path is ignored by a .geminiignore pattern', async () => {
      const params: ReadFileToolParams = {
        abs_path: path.join(tempRootDir, 'foo.bar'),
      };
      const result = await tool.execute(params, abortSignal);

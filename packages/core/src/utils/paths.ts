 ...
 * @returns A truncated SHA256 hash of the project root path (first 8 characters).
 */
export function getProjectHash(projectRoot: string): string {
  return crypto.createHash('sha256').update(projectRoot).digest('hex').substring(0, 8);
}
